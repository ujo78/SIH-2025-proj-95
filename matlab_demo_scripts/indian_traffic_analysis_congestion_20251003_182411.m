...
% Generated on: 2025-10-03 18:24:11
...
% Load indian_traffic_demo_trajectories_20251003_182411
try
    if exist('matlab_demo_exports\indian_traffic_demo_trajectories_20251003_182411.mat', 'file')
        data_1 = load('matlab_demo_exports\indian_traffic_demo_trajectories_20251003_182411.mat');
        loaded_files{end+1} = 'matlab_demo_exports\indian_traffic_demo_trajectories_20251003_182411.mat';
        fprintf('  Loaded: matlab_demo_exports\indian_traffic_demo_trajectories_20251003_182411.mat\n');
        
        % Store in main data structure
        [~, name, ~] = fileparts('matlab_demo_exports\indian_traffic_demo_trajectories_20251003_182411.mat');
        simulation_data.(name) = data_1;
    else
        warning('File not found: matlab_demo_exports\indian_traffic_demo_trajectories_20251003_182411.mat');
    end
catch ME
    warning('Error loading matlab_demo_exports\indian_traffic_demo_trajectories_20251003_182411.mat: %s', ME.message);
end

% Load indian_traffic_demo_road_network_20251003_182411
try
    if exist('matlab_demo_exports\indian_traffic_demo_road_network_20251003_182411.mat', 'file')
        data_2 = load('matlab_demo_exports\indian_traffic_demo_road_network_20251003_182411.mat');
        loaded_files{end+1} = 'matlab_demo_exports\indian_traffic_demo_road_network_20251003_182411.mat';
        fprintf('  Loaded: matlab_demo_exports\indian_traffic_demo_road_network_20251003_182411.mat\n');
        
        % Store in main data structure
        [~, name, ~] = fileparts('matlab_demo_exports\indian_traffic_demo_road_network_20251003_182411.mat');
        simulation_data.(name) = data_2;
    else
        warning('File not found: matlab_demo_exports\indian_traffic_demo_road_network_20251003_182411.mat');
    end
catch ME
    warning('Error loading matlab_demo_exports\indian_traffic_demo_road_network_20251003_182411.mat: %s', ME.message);
end

% Load indian_traffic_demo_metrics_20251003_182411
try
    if exist('matlab_demo_exports\indian_traffic_demo_metrics_20251003_182411.mat', 'file')
        data_3 = load('matlab_demo_exports\indian_traffic_demo_metrics_20251003_182411.mat');
        loaded_files{end+1} = 'matlab_demo_exports\indian_traffic_demo_metrics_20251003_182411.mat';
        fprintf('  Loaded: matlab_demo_exports\indian_traffic_demo_metrics_20251003_182411.mat\n');
        
        % Store in main data structure
        [~, name, ~] = fileparts('matlab_demo_exports\indian_traffic_demo_metrics_20251003_182411.mat');
        simulation_data.(name) = data_3;
    else
        warning('File not found: matlab_demo_exports\indian_traffic_demo_metrics_20251003_182411.mat');
    end
catch ME
    warning('Error loading matlab_demo_exports\indian_traffic_demo_metrics_20251003_182411.mat: %s', ME.message);
end
